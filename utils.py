...
def bl_info() -> dict[str, Any]:
    """
    Returns a bl_info metadata dictionary in the form:
    {
        "name": "My Script",
    ...
    with open("meta.json") as meta:
        bl_info.update(json.load(meta))

    bl_info["version"] = tuple(bl_info["version"])
    bl_info["blender"] = tuple(bl_info["blender"])
